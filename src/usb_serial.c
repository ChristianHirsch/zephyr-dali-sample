...
LOG_MODULE_REGISTER(usb_serial, LOG_LEVEL_DBG);
...
static int usb_serial_init(void)
{
	...
	LOG_INF("USB serial initialized %s", CONFIG_ARCH);

	return 0;
}

SYS_INIT(usb_serial_init, APPLICATION, CONFIG_APPLICATION_INIT_PRIORITY);
